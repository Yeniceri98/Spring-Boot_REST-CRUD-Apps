...
/*
    Diğer DAO implementasyonlarından farklı olarak Spring Data REST kullanıp kullanım kolaylığı sağladık
    Spring Data REST JpaRepository'den metodları scan eder
    EmployeeRestController ve EmployeeService class'larına artık ihtiyaç kalmaz. Bunları silebiliriz
*/